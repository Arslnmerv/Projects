...
import java.util.Scanner;
    ...
    public class Shop {
        ...
        ArrayList<Urunler> urunSec(Shop gs) {
            ...
            do {
                menu();
                System.out.println("Almak istediginiz Ã¼rÃ¼nlerin numarasini giriniz, Birden fazla Ã¼rÃ¼n secebilirsiniz. \nNot: Secmek istedigininz urun numarasini 11 yada 23  gibi yanyana yazabilirisiniz. ");
        ...
        int taksitBelirle() {
            ...
            Scanner sc = new Scanner(System.in);
            do {
                System.out.println("Ã–demeniz Gereken Toplam Tutar : "+ toplamAlisVerisTutari);
        ...
        void taksitleriYazdir() {
            System.out.println("Aldiginiz ÃœrÃ¼nler : ");
            System.out.println("-------------------");
            for (Urunler urunler : secilenUrunler) {
                System.out.println(urunler.toString());
            }
            System.out.println("Toplam Ã–denecek Miktar : " + toplamAlisVerisTutari);
            System.out.println("Tercih Edilen Taksit Miktari : " + taksit);
            System.out.println("Ã–deme Tablosu : ");
            System.out.println("---------------");
            int i = 0;
